...
CREATE TABLE IF NOT EXISTS `pizzeria`.`comandes` (
  ...
  `tipusComanda` ENUM('local', 'domicili', 'recollida') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pizzeria`.`Productes` (
  ...
  `Preu` DOUBLE NULL,
  `tipusProducte` ENUM('pizza', 'beguda', 'hamburguesa') NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pizzeria`.`ProductesComandes` ;
